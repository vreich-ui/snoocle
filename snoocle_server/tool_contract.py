...
TOOL_CONTRACTS: dict[str, ToolContract] = {
    ...
    "analyze_full_track_mir": _contract(
        "analyze_full_track_mir", "MIR", "server_filesystem_restricted", ("audio_file",),
        ("mir_analysis",), duration="minutes", renderer="mir",
    ),
    "analyze_mir_window": _contract(
        "analyze_mir_window", "MIR", "server_filesystem_restricted", ("audio_file",),
        ("mir_analysis",), duration="seconds", renderer="mir",
    ),
    ...
    "calculate_recording_offset": _contract(
        ...
        ("audio_file", "audio_file"), ("recording_offset",), duration="seconds",
    ...
    "align_song_deterministically": _contract(
        ...
        ("song", "audio_file", "recording", "mir_analysis", "candidate_collection", "lrc"),
        ("song", "run_trace", "quality_report"), read_only=False, idempotent=False,
        network=("external:youtube", "external:lrclib", "store_backend"),
    ...
    "process_song_deterministically": _contract(
        ...
        ("song_identity", "audio_file", "recording", "mir_analysis", "candidate_collection", "lrc"),
        ("song", "run_trace", "quality_report"), read_only=False, idempotent=False,
        network=("external:web", "external:youtube", "external:lrclib", "store_backend"),
        persistence=("run_trace_write", "song_version_optional", "cache"),
        cache="read_write", duration="minutes", renderer="song",
    ),
    ...
    "acquire_audio": _contract(
        ...
        ("audio_file", "recording"), read_only=False, idempotent=False,
        network=("external:youtube",), persistence=("cache", "filesystem"),
        cache="read_write", duration="minutes", renderer="audio",
    ),
    "analyze_audio": _contract(
        "analyze_audio", "MIR", "server_filesystem_restricted",
        ("audio_file", "song_identity", "recording"), ("mir_analysis", "audio_file"),
        read_only=False, idempotent=False, network=("external:youtube",),
        persistence=("cache", "ephemeral_filesystem"), cache="read_write",
        duration="minutes", renderer="mir",
    ),
    "reconcile_song": _contract(
        "reconcile_song", "agent reconciliation", "server_filesystem_restricted",
        ("song_identity", "candidate_collection", "mir_analysis", "audio_file", "song"),
        ("song", "run_trace", "evidence_manifest"), read_only=False, idempotent=False,
        network=("external:web", "external:model_provider", "store_backend"), model_use="required",
    ...
    "convert_audio": _contract(
        "convert_audio", "audio", "server_filesystem_restricted", ("audio_file",),
        ("audio_file",), read_only=False, destructive=True,
        persistence=("filesystem",), duration="seconds", renderer="audio",
    ),
    "trim_audio": _contract(
        "trim_audio", "audio", "server_filesystem_restricted", ("audio_file",),
        ("audio_file",), read_only=False, destructive=True,
        persistence=("filesystem",), duration="seconds", renderer="audio",
    ),
    "normalize_audio": _contract(
        "normalize_audio", "audio", "server_filesystem_restricted", ("audio_file",),
        ("audio_file",), read_only=False, destructive=True,
        persistence=("filesystem",), duration="seconds", renderer="audio",
    ),
    "probe_audio": _contract(
        "probe_audio", "audio", "server_filesystem_restricted", ("audio_file",),
        ("audio_probe",), persistence=("ephemeral_filesystem",), renderer="audio_probe",
    ),
